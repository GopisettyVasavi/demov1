...
public class CandidatePersonalEntity {
	...
	public String toString() {
		return "CandidatePersonalEntity [candidateId=" + candidateId + ", candidateName=" + candidateName
				...
				+ ", currentLocation=" + currentLocation + ", dateOfBirth=" + dateOfBirth + ", socialMediaLink="
				+ socialMediaLink + ", nationality=" + nationality + ", visaType=" + visaType + ", visaNo=" + visaNo
				+ ", validUpto=" + validUpto + ", workExperience=" + workExperience + ", lastUpdatedByUser="
				+ lastUpdatedByUser + ", firstName=" + firstName + ", middleName=" + middleName + ", lastName="
				+ lastName + ", lastUpdatedByDateTime=" + lastUpdatedByDateTime + "]";
	}
